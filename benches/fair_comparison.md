...
| 实现 | 时间 | 相对速度 |
|------|------|----------|
| **cmark (C)** | **1.0 ms** | 1.00x (最快) |
| **clmd (Rust)** | **1.2 ms** | 1.20x (慢 20%) |
| **commonmark.js (JS)** | **66.7 ms** | 64.4x (慢 64 倍) |
...
Benchmark 1: ./target/release/examples/cross_language_bench benches/samples/lorem1.md
  Time (mean ± σ):       1.2 ms ±   0.7 ms    [User: 0.6 ms, System: 0.3 ms]

Benchmark 2: /Users/wangq/Scripts/clmd/cmark-0.31.2/build/src/cmark benches/samples/lorem1.md
  Time (mean ± σ):       1.0 ms ±   0.9 ms    [User: 0.4 ms, System: 0.3 ms]

Benchmark 3: node /Users/wangq/Scripts/clmd/bench_commonmark.js benches/samples/lorem1.md
  Time (mean ± σ):      66.7 ms ±  10.2 ms    [User: 60.7 ms, System: 8.9 ms]

Summary
  cmark ran 1.20 times faster than clmd
  cmark ran 64.41 times faster than commonmark.js
```
...
| **clmd (Rust)** | **3.6 ms** | 1.33x (慢 33%) |
| **commonmark.js (JS)** | **79.7 ms** | 29.4x (慢 29 倍) |
...
Benchmark 1: ./target/release/examples/cross_language_bench benches/samples/lorem-xlarge.md
  Time (mean ± σ):       3.6 ms ±   0.3 ms    [User: 2.5 ms, System: 0.7 ms]

Benchmark 2: /Users/wangq/Scripts/clmd/cmark-0.31.2/build/src/cmark benches/samples/lorem-xlarge.md
  Time (mean ± σ):       2.7 ms ±   0.9 ms    [User: 1.6 ms, System: 0.6 ms]

Benchmark 3: node /Users/wangq/Scripts/clmd/bench_commonmark.js benches/samples/lorem-xlarge.md
  Time (mean ± σ):      79.7 ms ±  14.1 ms    [User: 85.9 ms, System: 10.8 ms]

Summary
  cmark ran 1.33 times faster than clmd
  cmark ran 29.44 times faster than commonmark.js
```
...
| 文档 | 大小 | 解析时间 | 吞吐量 |
|------|------|----------|--------|
| `lorem1.md` | ~1KB | 17.99 µs | ~55 MB/s |
| `lorem-large.md` | ~7KB | 106.88 µs | ~65 MB/s |
| `lorem-xlarge.md` | ~110KB | 1.49 ms | ~73 MB/s |

**观察**:
- 解析时间与文档大小呈线性关系
- 吞吐量随文档大小提升（55 → 65 → 73 MB/s）
- 性能随文档大小扩展良好，大文件吞吐量更高
...
|---------|-----------|-------------|---------------|
| 小文件 (1KB) | 1.0 ms | 1.2 ms (慢 20%) | 66.7 ms (慢 64 倍) |
| 大文件 (110KB) | 2.7 ms | 3.6 ms (慢 33%) | 79.7 ms (慢 29 倍) |
...
3. **稳定的吞吐量**
   - 52-55 MB/s across all document sizes
   - 线性扩展性良好
...
|------|------|-------------|---------------|------|
| cmark | C | 1.0 ms | 2.7 ms | 原生性能，无 GC |
| clmd | Rust | 1.2 ms | 3.6 ms | 内存安全，Arena 分配 |
| commonmark.js | JS | 66.7 ms | 79.7 ms | 跨平台，易用 |

### 优化成果

经过多轮优化，clmd 与 cmark 的差距显著缩小：
- 小文件差距从 27% 降至 20%
- 大文件差距从 65% 降至 33%
