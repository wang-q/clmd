//! Link reference formatter for reference-style links
//!
//! This module provides functionality for formatting reference-style links,
//! inspired by flexmark-java's NodeRepositoryFormatter.
//! It handles the collection, sorting, and placement of link references.
