...
pub fn find_abbreviations(text: &str, abbreviations: &HashMap<String, Abbreviation>) -> Vec<(usize, usize, String)> {
...
pub fn replace_abbreviations(text: &str, abbreviations: &HashMap<String, Abbreviation>) -> String {
...
mod tests {
    ...
    fn test_is_abbreviation_def() {
        ...
        assert!(is_abbreviation_def("  *[API]: Application Programming Interface"));
    ...
    fn test_parse_abbreviation_def() {
        ...
        assert_eq!(result, Some(("HTML".to_string(), "Hyper Text Markup Language".to_string())));
        
        let result = parse_abbreviation_def("*[API]: Application Programming Interface");
        assert_eq!(result, Some(("API".to_string(), "Application Programming Interface".to_string())));
    }
