...
//!
//! This module provides a complete lookup table for all 2125 HTML5 named entities.
//! Entities are stored in a sorted array for efficient binary search.
//!
//! Based on the HTML5 specification: https://html.spec.whatwg.org/entities.json

/// Lookup a named entity by its name (case-sensitive)
/// Returns the corresponding Unicode character(s) if found
