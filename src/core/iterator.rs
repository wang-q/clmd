...
//!
//! This module provides iterators for traversing the AST in various ways:
//! - Depth-first traversal with enter/exit events
//! - Walker for convenient tree navigation
//!
...
//!
//! ```rust,ignore
//! use clmd::core::iterator::{ArenaNodeIterator, EventType};
//!
