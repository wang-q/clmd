...
fn run_formatter_spec_file(spec_file: &str) {
    ...
    println!("\n=== Line Breaking Integration Spec Test Results ===");
    println!(
        "Passed: {}/{} ({:.1}%)",
        passed,
        examples.len(),
...
#[test]
fn test_line_breaking_integration_spec() {
    run_formatter_spec_file("tests/fixtures/line_breaking_integration_spec.md");
}
